        ...
        <header id="home" className="relative h-[75vh] md:h-screen flex items-center justify-center overflow-clip">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src={heroImage}
                    alt="Save the Date"
                    className="w-full h-full object-cover [object-position:55%_20%] md:[object-position:center]"
                />
            ...
            <div className="relative z-10 text-center text-white px-4">
                ...
                <p className="text-xl sm:text-4xl md:text-5xl font-cormorant text-porcelain">
                    {typewriterText}
                ...
                <motion.p
                    ...
                    className="text-5xl sm:text-8xl md:text-[10rem] font-anastasia text-porcelain overflow-visible pr-4 leading-tight"
